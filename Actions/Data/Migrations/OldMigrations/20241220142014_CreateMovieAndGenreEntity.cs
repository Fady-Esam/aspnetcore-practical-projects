...
{
    /// <inheritdoc />
    public partial class CreateMovieAndGenreEntity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 4, "Inception", 351.53m, new DateOnly(2003, 1, 17) },
                    { 2, 4, "Shutter Island", 294.1m, new DateOnly(2012, 5, 22) },
                    { 3, 1, "The Matrix", 81.51m, new DateOnly(2009, 2, 13) },
                    { 4, 3, "God Father", 351.53m, new DateOnly(1995, 10, 3) },
                    { 5, 5, "The Maze Runner", 192.5m, new DateOnly(2018, 4, 10) }
                });
